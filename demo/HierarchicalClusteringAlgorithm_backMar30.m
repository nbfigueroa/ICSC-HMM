...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Construct Hierarchical Gaussian Models with Dendogram Tree Struct %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% for i=1:1 
    ...
    % Compute Similarity
    spcm = ComputeSPCMfunction(sigmas);    
    xi.spcm = spcm; 
    if dis       
        tnames = xi.behavs.treefun(@getName);        
        disp(tnames.tostring)        
...
%         Sigma_hat = Delta_hat*Delta_hat';
        ...
        if (node_flag==0)
            ...
            for j=1:2
                ...
                new_spcm = ComputeSPCMfunction(new_comp);
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Construct Hierarchical Gaussian Models with Phylogenetic Tree Struct %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
