...
[data] = genToySeqData_ARGaussian(5, 8, 5, 1000, 1); 
%%
...
initP  = {'F.nTotal', 1}; 
CH = runBPHMM( data, modelP, {5, 1}, algP, initP );
...
Psi90 = CH.Psi( CH.iters.Psi == 200 );
alignedPsi90 = alignPsiToTruth_OneToOne( Psi90, data );

Psi100 = CH.Psi( CH.iters.Psi == 300 );
